...
var file_call_proto_rawDesc = []byte{
	...
	0xc0, 0x01, 0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x34, 0x0a, 0x09, 0x55, 0x6e, 0x61, 0x72,
	...
	0x69, 0x6e, 0x67, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x11, 0x2e, 0x63, 0x61, 0x6c, 0x6c, 0x2e, 0x43,
...
var file_call_proto_depIdxs = []int32{
	...
	0, // 2: call.Call.ServerStreamingCall:input_type -> call.CallRequest
...
type CallClient interface {
	...
	ServerStreamingCall(ctx context.Context, in *CallRequest, opts ...grpc.CallOption) (Call_ServerStreamingCallClient, error)
}
...
func (c *callClient) ServerStreamingCall(ctx context.Context, in *CallRequest, opts ...grpc.CallOption) (Call_ServerStreamingCallClient, error) {
...
type CallServer interface {
	...
	// ServerStreaming Request:Response = 1:N
	ServerStreamingCall(*CallRequest, Call_ServerStreamingCallServer) error
}
...
func (*UnimplementedCallServer) ServerStreamingCall(*CallRequest, Call_ServerStreamingCallServer) error {
